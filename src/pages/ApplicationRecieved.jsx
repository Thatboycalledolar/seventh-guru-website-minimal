...
export default function ApplicationRecieved() {
  return(
    <div className="flex flex-col items-center w-full ">
      <div className=" bg-gray-100 w-full px-8 pt-36 mb-30">
        <div className="max-w-300 mx-auto flex flex-col items-center">
            <div className="flex flex-col items-center gap-6 mb-18 text-(--text-color) mt-20" >
              <h1 className="text-3xl md:text-4xl text-center font-bold">Application Submitted <br />Successfully</h1>
              <CircleCheck color="#0059AA" width={96} height={96} />
            </div>

            
              <p className="bg-gray-200 py-6 px-6 text-sm md:text-base rounded-lg gap-2  text-center md:w-[60%] mb-18">
